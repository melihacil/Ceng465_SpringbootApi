...
import com.distributed.MusicAppProject.MusicUsers.MusicObjects.Artist;
...
public class DeezerSearch {
     ...
     */
    public DeezerSearch(String userInput) {
     ...
     */
    public DeezerSearch(String userInput,String searchOrder) {
        this.userInput = userInput;
